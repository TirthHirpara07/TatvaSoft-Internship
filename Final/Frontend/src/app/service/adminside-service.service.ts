...
DeleteUser(userId: number): Observable<any> {
  ...
  return this.http.delete(`${this.apiUrl}/AdminUser/DeleteUser`,{params,observe:'body'});
}
  ...
  MissionList(): Observable<Mission[]> {
    return this.http.get<Mission[]>(`${this.apiUrl}/Mission/GetMissions`);
  }
  ...
  DeleteMission(id: number) {
    ...
    return this.http.delete(`${this.apiUrl}/Mission/DeleteMission`,{params,observe:'body'});
  }

  //Mission Application
  MissionApplicationList(): Observable<MissionApplication[]> {
    return this.http.get<MissionApplication[]>(
      `${this.apiUrl}/MissionApplication/MissionApplicationList`
    );
  }

  MissionApplicationDelete(id: any){
    const params = new HttpParams().set('id', id.toString());
    return this.http.post(`${this.apiUrl}/MissionApplication/MissionApplicationDelete`, {params,observe:'body'});
  }

  MissionApplicationApprove(id:any){
    const params = new HttpParams().set('id', id.toString());
    return this.http.post(`${this.apiUrl}/MissionApplication/MissionApplicationApprove`, {params,observe:'body'});
  }

  //Mission Theme
  MissionThemeList(): Observable<MissionTheme[]> {
    return this.http.get<MissionTheme[]>(
      `${this.apiUrl}/MissionTheme/GetMissionThemes`
    );
  }
  ...
  DeleteMissionTheme(data: any) {
    ...
    return this.http.delete(
      `${this.apiUrl}/MissionTheme/DeleteMissionTheme`,{params,observe:'body'}
    );
  }
  ...
  DeleteMissionSkill(data: any) {
    const params = new HttpParams().set('id', data.toString());
    return this.http.delete(
      `${this.apiUrl}/MissionSkill/DeleteMissionSkill`,{params,observe:'body'}
    );
  }
}
